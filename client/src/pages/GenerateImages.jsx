      ...
      >
        ...
        <div className="my-6 flex items-center gap-2">
          <label className="relative cursor-pointer">
            ...
            <span className="absolute top-1 left-1 w-3 h-3 bg-white rounded-full peer-checked:translate-x-4 transition"></span>
          </label>
          <span className="text-sm text-gray-600">Publish publicly</span>
        </div>
